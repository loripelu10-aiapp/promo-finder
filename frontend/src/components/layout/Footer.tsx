      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 text-sm max-w-md">
              Real-time fashion deals from top brands. Find the best discounts on clothing, shoes, and accessories.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/deals" className="text-gray-400 hover:text-orange-500 text-sm transition-colors">
                  All Deals
                </a>
              </li>
              <li>
                <a href="/analytics" className="text-gray-400 hover:text-orange-500 text-sm transition-colors">
                  Analytics
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/faq" className="text-gray-400 hover:text-orange-500 text-sm transition-colors">
                  FAQ
                </a>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {currentYear} PromoFinder. All rights reserved.
          </p>
